...
| [04-pilot-plan.md](./04-pilot-plan.md) | Year-one Northern Portugal pilot: masters, students, MVP app, metrics, open questions |
| [ORCHESTRATOR.md](./ORCHESTRATOR.md) | Handoff brief for remote agents: state, priorities, next instructions |

**Source material:** [`../src/chat.md`](../src/chat.md) — raw ChatGPT conversation export (preserved, not edited).
...
> The community matters more than the software.

v1 explicitly excludes social features and heavy tech. Booking and trust come first.
