...
## The Triangle of Transmission

At the center of the platform is the **transmission of knowledge across generations**. The triangle represents the cycle that keeps knowledge alive.
...
Each role supports the others. If one disappears, the system collapses:

| Missing role | Consequence |
|--------------|-------------|
| **Students** | Knowledge dies |
| **Masters** | Knowledge degrades |
| **Stewards** | Land and context vanish |

The triangle can serve as the platform’s core symbol.
...
Curious learners seeking knowledge.

**Examples:** designers, farmers, architects, travelers, curious individuals.

**Posture:** humility and curiosity.
...
**Posture:** transmission of knowledge.

### Steward

People responsible for protecting place and tradition.

**Examples:** forest restorers, indigenous knowledge keepers, landscape stewards.

**Posture:** guardianship.

---

## The Life Cycle

Roles evolve with a person’s journey:

1. Begin as a **student**
2. Grow into a **master**
3. Eventually become a **steward** of knowledge and place

This progression creates a **living lineage** rather than static user types.

---

## Platform Design Implications

Instead of generic user profiles, the platform highlights **role within the triangle**.

**Example — Master profile**

- Role: Master  
- Craft: Dry stone masonry  
- Location: Serra da Estrela  

**Example — Steward profile**
...
Historically, *studium* meant a place devoted to learning. The full concept:

**Studium** — a place where:
...
## Narrative and Guiding Principle
