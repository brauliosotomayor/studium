...
### Primary region: Northern Portugal
...
### Founding masters (target: 10)

The founding circle defines platform DNA. Aim for **diversity of craft and land knowledge**.

**Craft masters (examples):**
...
**Land stewards (examples):**

- Vineyard steward
- Native plant nursery
- Regenerative farmer
- Forest restoration practitioner
- Herbalist / ethnobotanist

Together: a balance of **craft + land**.

### First apprenticeship experiences

Keep offerings **simple and immersive**.
...
Every apprenticeship should be documented:
...
Potential partners (e.g. UNESCO, heritage groups) often seek apprenticeship programs; Studium could become a channel for student placement and program support.
...
1. **Founding master:** Who is the very first person invited—the first point on the map? A craftsperson, a land steward, or someone already in the network? This choice sets tone for the entire network.

2. **Exact sub-region focus:** Run across all four example areas (Douro, Minho, Serra da Estrela, Trás-os-Montes) or concentrate launch in one for logistics and storytelling?

3. **Final founding circle:** Which 10 masters (names, locations, crafts) commit for year one?

4. **Scheduling and capacity:** How many apprenticeship runs per master per year to hit ~50 completions with 3–6 students each?
